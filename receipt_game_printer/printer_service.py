...
class PrinterService:
    ...
    def _write_styled_receipt(self, h_printer, receipt: StyledReceipt) -> None:
        ...
        for block in receipt.blocks:
            ...
            if stripped.startswith("[NF LOGO]"):
                ...
                if not self.print_bitmap_logo(h_printer, code, block.style.align):
            ...
            win32print.WritePrinter(h_printer, f"{block.text}\n".encode("cp857", errors="replace"))
            self._write_style_reset(h_printer)
        self._write_style_reset(h_printer)
    ...
    def print_bitmap_logo(self, h_printer, footer_logo_code: str = "", align: str = "center") -> bool:
