...
# "." = boş piksel
#
# Bu sürüm önceki 68x24 kalın logoya göre daha dar ve daha ince tutulmuştur.
# Font, Unicode, Pillow, PNG veya koordinat tabanlı çizim kullanılmaz.
# ---------------------------------------------------------------------------
...
def _build_logo_pixels() -> list[list[int]]:
    ...
    if NF_LOGO_WIDTH <= 0:
        raise ValueError(
            "NF logo bitmap width must be greater than zero"
        )
...
class PrinterService:
    ...
    def print_bitmap_logo(
        ...
        Firma kodu rasterlaştırılmaz.
        Logo sonrasında normal CP857 metni olarak gönderilir.
        """
