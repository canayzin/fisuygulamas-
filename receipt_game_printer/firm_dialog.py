...
FIELD_LABELS = {
    ...
    "tax_office": "Vergi Dairesi / Vergi No",
    "trade_registry_no": "T. Sicil No (opsiyonel)",
    "eku_no": "EKU No",
    "z_no": "Z No",
    "footer_logo_code": "Alt Logo Kodu",
...
class FirmDialog(tk.Toplevel):
    def __init__(self, parent: tk.Misc, initial: Firm | None = None):
        ...
        self.vars = {
            ...
            "trade_registry_no": tk.StringVar(value=getattr(initial, "trade_registry_no", "")),
            "eku_no": tk.StringVar(value=getattr(initial, "eku_no", "")),
            "z_no": tk.StringVar(value=getattr(initial, "z_no", "")),
            "footer_logo_code": tk.StringVar(value=getattr(initial, "footer_logo_code", "")),
    ...
    def _save(self):
        ...
        self.result = Firm(
            ...
            trade_registry_no=self.vars["trade_registry_no"].get().strip(),
            eku_no=self.vars["eku_no"].get().strip(),
            z_no=self.vars["z_no"].get().strip(),
            footer_logo_code=self.vars["footer_logo_code"].get().strip(),
